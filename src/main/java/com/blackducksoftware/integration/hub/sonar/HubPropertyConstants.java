...
public class HubPropertyConstants {
    ...
    public static class Definitions {
        ...
        private static final String CATEGORY_OVERRIDE = "Override Properties";

        public static final PropertyDefinition HUB_URL = buildDef(HubPropertyConstants.HUB_URL, PropertyType.STRING, "Hub URL: ", "Specify the URL of your Hub installation, for example: http://hub.blackducksoftware.com", "",
                CATEGORY_GENERAL, 0);
        public static final PropertyDefinition HUB_USERNAME = buildDef(HubPropertyConstants.HUB_USERNAME, PropertyType.STRING, "Username: ", "The Hub username.", "", CATEGORY_GENERAL, 1);
        public static final PropertyDefinition HUB_PASSWORD = buildDef(HubPropertyConstants.HUB_PASSWORD, PropertyType.PASSWORD, "Password: ", "The password for the specified Hub user.", "", CATEGORY_GENERAL, 2);
        public static final PropertyDefinition HUB_TIMEOUT = buildDef(HubPropertyConstants.HUB_TIMEOUT, PropertyType.INTEGER, "Timeout (secs): ", "Hub connection timeout.", "120", CATEGORY_GENERAL, 3);
        ...
        public static final PropertyDefinition HUB_PROXY_PORT = buildDef(HubPropertyConstants.HUB_PROXY_PORT, PropertyType.INTEGER, "Proxy Port: ", "The port to be used to connect to the Proxy Server.", "", CATEGORY_PROXY, 6);
        ...
        public static final PropertyDefinition HUB_BINARY_INCLUSION_PATTERN_OVERRIDE = buildDef(HubPropertyConstants.HUB_BINARY_INCLUSION_PATTERN_OVERRIDE, PropertyType.STRING, "Binary Inclusion Patterns: ",
                "File patterns used for gathering local components.", ComponentHelper.DEFAULT_INCLUSION_PATTERNS, CATEGORY_OVERRIDE, 10);
        public static final PropertyDefinition HUB_BINARY_EXCLUSION_PATTERN_OVERRIDE = buildDef(HubPropertyConstants.HUB_BINARY_EXCLUSION_PATTERN_OVERRIDE, PropertyType.STRING, "Binary Exclusion Patterns: ",
                "File patterns used for gathering local components.", ComponentHelper.DEFAULT_EXCLUSION_PATTERNS, CATEGORY_OVERRIDE, 11);

        private static PropertyDefinition buildDef(final String prop, final PropertyType type, final String name, final String desc, final String defaultVal, final String subCategory, final int index) {
